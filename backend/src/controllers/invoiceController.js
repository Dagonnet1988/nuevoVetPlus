...
export async function createInvoice(req, res) {
  try {
    ...
    try {
      ...
      // Crear la factura - codigo_factura se genera automáticamente
      ...
      `, [id_cliente, id_consulta, descuento, tipo_pago, notas, idCaja, userId]);      
      ...
      // Calcular totales (impuestos = 0 por defecto, se puede configurar después si es necesario)
      ...
      await query(`
        ...
        SET impuestos = $1, estado = $2
        WHERE id_factura = $3
      `, [impuestos, estadoFinal, factura.id_factura]);
      ...
      if (tipo_pago !== 'Crédito') {
        ...
        `, [codigoIngreso, idCaja, `Pago de factura ${factura.codigo_factura}`, total, factura.codigo_factura, tipo_pago, userId]);
